...
async function downloadPDF() {
  try {
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    if (typeof window.configuratorRecompute === 'function') {
      window.configuratorRecompute(); // To wywoła exposeSelectionOnWindow() i zaktualizuje window.configuratorSelection
    }
    ...
    const recommendedPowerKw = window.lastCalculationResult?.recommended_power_kw ||
                                window.lastCalculationResult?.max_heating_power ||
                                null;
